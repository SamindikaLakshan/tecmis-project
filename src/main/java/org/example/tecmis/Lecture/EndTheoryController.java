...
public class EndTheoryController {

    @FXML
    private TableColumn<EndTheoryController, String> endMarks;

    @FXML
    private TableView<EndTheoryController> endTheoryTable;

    @FXML
    private TableColumn<EndTheoryController, String> courseID;

    @FXML
    private TableColumn<EndTheoryController, String> studentID;
    ...
    public void show() {
        ...
        try{
            ...
            String query="select * from end_theory";

            endTheoryTable.getItems().clear();
            ...
            while (rs.next()) {
                ...
                EndTheory add_record = new EndTheory(stdId,crsId,endMark);
                endTheoryTable.getItems().add(add_record);
            }
    ...
    void editMark(ActionEvent event) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("EditEndTheory.fxml"));
