...
public class Attendenceview {
    @FXML
    private TableView<Person> attendance_table;

    @FXML
    private TableColumn<Person, String> attendenceid;
    ...
    private void handleView() {
        ...
        try {
            ...
            String myStatement = "SELECT * FROM attendance";
            ...
            attendance_table.setItems(tecofficer);

            attendenceid.setCellValueFactory(f -> f.getValue().idProperty());
